...
function hasAuthConfig() {
  return Boolean(process.env.ADMIN_EMAIL && process.env.APP_PASSWORD)
}
...
function credentialsMatch(email, password) {
  ...
  return hasAuthConfig() && safeEqual(normalizedEmail, configuredEmail) && safeEqual(password, process.env.APP_PASSWORD)
}
...
module.exports = { clearSessionCookie, createSessionCookie, credentialsMatch, hasAuthConfig, isAuthorized, readJson, sendJson }
