const CACHE_NAME = 'family-recipes-shell-v14'
const IMAGE_CACHE_NAME = 'family-recipes-image-responses-v1'
const IMAGE_RESPONSE_LIMIT = 500
const APP_SHELL = ['/', '/index.html?v=v1.0.14', '/manifest.json?v=v1.0.14', '/src/styles.css?v=v1.0.14', '/src/main.js?v=v1.0.14', '/src/cloud.js', '/src/supabase-session.js', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/apple-touch-icon-180.png']
